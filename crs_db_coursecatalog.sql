...
CREATE TABLE `coursecatalog` (
  ...
  `professorAlloted` int NOT NULL DEFAULT '-1',
  `Credits` int NOT NULL,
  `Prerequisties` varchar(45) NOT NULL,
  PRIMARY KEY (`couseId`),
...
INSERT INTO `coursecatalog` VALUES (401,'DS',201,5,'NA'),(402,'CN',202,5,'NA'),(403,'Algo',201,5,'NA'),(404,'DM',202,5,'NA'),(405,'TOC',203,5,'NA'),(406,'Compiler',204,5,'NA'),(407,'OS',203,5,'NA');
...
-- Dump completed on 2022-01-25 13:14:34
